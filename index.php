...
<body>
    ...
    <div class="container">
        ...
        <div class="faq">
            <h2><?php echo $item['quest'] ?></h2>
            <p><?php echo $item['answear'] ?></p>
        </div>
        <?php } ?>
    </div>
